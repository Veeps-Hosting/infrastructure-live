...
All the Terraform code for this module is defined in [infrastructure-modules/security/iam-user-password-policy](https://github.com/Veeps-Hosting/infrastructure-modules/tree/master/security/iam-user-password-policy).
...
For more info, check out the Readme for this module in [infrastructure-modules/security/iam-user-password-policy](https://github.com/Veeps-Hosting/infrastructure-modules/tree/master/security/iam-user-password-policy).