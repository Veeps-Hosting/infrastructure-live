...
https_listener_ports_and_ssl_certs = [
  {
    port    = 443
    tls_arn = "arn:aws:iam::159447213031:server-certificate/services-prod.veeps-hosting.aws"
  },
]

num_days_after_which_archive_log_data = 30
num_days_after_which_delete_log_data = 60
access_logs_s3_bucket_name = "veeps-hosting-prod-alb-internal-access-logs"

create_route53_entry = true
domain_name = "services-prod.veeps-hosting.aws"
