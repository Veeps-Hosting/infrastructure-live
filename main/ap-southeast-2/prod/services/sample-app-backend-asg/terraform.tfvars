...
terragrunt = {
  ...
  terraform {
    source = "git::ssh://git@github.com/Veeps-Hosting/infrastructure-modules.git//services/asg-service?ref=v0.0.1"
  }
  ...
  dependencies = {
    paths = ["../../vpc", "../../data-stores/aurora", "../../networking/alb-internal", "../../../_global/sns-topics", "../../../../us-east-1/_global/sns-topics", "../../kms-master-key"]
  }
}
...
name = "sample-app-backend-asg-prod"
ami = "ami-0dc4f6bf20a263f08"
init_script_path = "/opt/sample-app-backend/bin/run-app.sh"
server_port = 8080

instance_type = "m4.large"
keypair_name = "prod-services-ap-southeast-2-v1"
