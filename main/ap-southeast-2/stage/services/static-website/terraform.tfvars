...
terragrunt = {
  ...
  terraform {
    source = "git::ssh://git@github.com/Veeps-Hosting/infrastructure-modules.git//services/static-website?ref=v0.0.1"
  }
...
website_domain_name = "static-stage.propertyiq-cloud.net"
