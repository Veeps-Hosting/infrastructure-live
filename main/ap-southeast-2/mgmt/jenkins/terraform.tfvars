...
terragrunt = {
  ...
  terraform {
    source = "git::ssh://git@github.com/Veeps-Hosting/infrastructure-modules.git//mgmt/jenkins?ref=v0.0.1"
  }
  ...
  dependencies = {
    paths = ["../vpc", "../openvpn-server", "../../_global/sns-topics", "../../../_global/route53-public"]
  }
}
